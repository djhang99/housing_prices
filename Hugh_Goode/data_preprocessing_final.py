...
def initiate_data(housing):
    ...
    train_data_linear, test_data_linear = train_test_split(housing_linear, test_size=0.2, random_state = 3)
    ...
    train_data_tree, test_data_tree = train_test_split(housing_tree, test_size=0.2, random_state = 3)
